 ...
 * @author 91807
 */
public class Foodup extends javax.swing.JFrame {
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                .addComponent(resname, javax.swing.GroupLayout.DEFAULT_SIZE, 220, Short.MAX_VALUE)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            user=Long.parseLong(resname.getText());
            addr=Long.parseLong(foodname.getText());
            pass=Long.parseLong(quantity.getText());
            String execute="INSERT INTO STJ38249.\"FOODT\" (\"RESID\",\"FOODID\",\"QUANTITY\") VALUES ("+user+",'"+addr+"',"+pass+")";
            statement.executeUpdate(execute);
            JOptionPane.showMessageDialog(null,"Food Updated details added.","",JOptionPane.PLAIN_MESSAGE);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Foodup.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
